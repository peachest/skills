...
> 源文档: [https://code.visualstudio.com/api/ux-guidelines/editor-actions](https://code.visualstudio.com/api/ux-guidelines/editor-actions)
		...
		<aside class="docs-left-sidebar"><nav id="docs-navbar" aria-label="Topics" class="docs-nav visible-md visible-lg"><h4>Extension API</h4>
			...
			<li class="panel active expanded">
			  ...
			  <ul id="ux-guidelines-articles" class="collapse in"><li>
			        ...
			        <li class="active">
			          <a href="/api/ux-guidelines/editor-actions" aria-label="Current Page: Editor Actions">Editor Actions</a>
			        </li>
