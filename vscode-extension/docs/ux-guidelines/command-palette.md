...
> 源文档: [https://code.visualstudio.com/api/ux-guidelines/command-palette](https://code.visualstudio.com/api/ux-guidelines/command-palette)
		...
		<aside class="docs-left-sidebar"><nav id="docs-navbar" aria-label="Topics" class="docs-nav visible-md visible-lg"><h4>Extension API</h4>
			...
			<li class="panel active expanded">
			  ...
			  <ul id="ux-guidelines-articles" class="collapse in"><li>
			        ...
			        <li class="active">
			          <a href="/api/ux-guidelines/command-palette" aria-label="Current Page: Command Palette">Command Palette</a>
			        </li>
