...
> 源文档: [https://code.visualstudio.com/api/ux-guidelines/settings](https://code.visualstudio.com/api/ux-guidelines/settings)
		...
		<aside class="docs-left-sidebar"><nav id="docs-navbar" aria-label="Topics" class="docs-nav visible-md visible-lg"><h4>Extension API</h4>
			...
			<li class="panel active expanded">
			  ...
			  <ul id="ux-guidelines-articles" class="collapse in"><li>
			        ...
			        <li class="active">
			          <a href="/api/ux-guidelines/settings" aria-label="Current Page: Settings">Settings</a>
			        </li>
...
<ul><li>Create your own settings page/webview</li>
<li>Create long descriptions</li>
</ul><p><img src="/assets/api/ux-guidelines/examples/settings.png" alt="Settings" loading="lazy"></p>
<p><em>This example links to a specific setting using the setting ID.</em></p>
<h2 id="links" data-needslink="links">Links</h2>
<ul><li><a href="/api/references/contribution-points#contributes.configuration">Configuration contribution point</a></li>
</ul><div class="feedback" data-edit-url="https://vscode.dev/github/microsoft/vscode-docs/blob/main/api/ux-guidelines/settings.md"></div>
				
				<div class="body-footer">6/3/2026</div>
				
            </main><aside class="docs-right-sidebar hidden-xs"><div class="docs-markdown-actions">
                    <div class="docs-markdown-dropdown" data-raw-url="/raw/api/ux-guidelines/settings.md">
