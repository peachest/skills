...
> 源文档: [https://code.visualstudio.com/api/get-started/wrapping-up](https://code.visualstudio.com/api/get-started/wrapping-up)
	...
	<div class="docs-layout-wrapper">
		...
		<aside class="docs-left-sidebar"><nav id="docs-navbar" aria-label="Topics" class="docs-nav visible-md visible-lg"><h4>Extension API</h4>
			...
			<li class="panel active expanded">
			  ...
			  <ul id="get-started-articles" class="collapse in"><li>
			        ...
			        <li class="active">
			          <a href="/api/get-started/wrapping-up" aria-label="Current Page: Wrapping Up">Wrapping Up</a>
			        </li>
...
<li>How to set up <a href="/api/working-with-extensions/continuous-integration">Continuous Integration</a> for your extension</li>
                ...
                <nav id="docs-subnavbar" aria-label="On Page"><h4><span class="sr-only">On this page there are 5 sections</span><span aria-hidden="true">On this page</span></h4>
                    <ul class="nav"><li><a href="#extension-capabilities">Extension Capabilities</a></li>
                        
                        <li><a href="#guides-samples">Guides &amp; Samples</a></li>
                        
                        <li><a href="#ux-guidelines">UX Guidelines</a></li>
                        
                        <li><a href="#issue-reporting">Issue Reporting</a></li>
                        
                        <li><a href="#testing-and-publishing">Testing and Publishing</a></li>
