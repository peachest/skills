...
- **[implement](./implement/SKILL.md)** — Build the work described by a spec or set of tickets, driving `/skill:tdd` at pre-agreed seams and closing out with `/skill:code-review` before committing.
