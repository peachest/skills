...
- **Want to explore alternative interfaces for the deepened module?** Run the `/skill:codebase-design` skill and use its design-it-twice parallel sub-agent pattern.
