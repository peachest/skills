...
> 源文档: [https://code.visualstudio.com/api/ux-guidelines/activity-bar](https://code.visualstudio.com/api/ux-guidelines/activity-bar)
		...
		<aside class="docs-left-sidebar"><nav id="docs-navbar" aria-label="Topics" class="docs-nav visible-md visible-lg"><h4>Extension API</h4>
			...
			<li class="panel active expanded">
			  ...
			  <ul id="ux-guidelines-articles" class="collapse in"><li>
			        ...
			        <li class="active">
			          <a href="/api/ux-guidelines/activity-bar" aria-label="Current Page: Activity Bar">Activity Bar</a>
			        </li>
...
<li><a href="/api/references/contribution-points#contributes.views">View contribution point</a></li>
</ul><div class="feedback" data-edit-url="https://vscode.dev/github/microsoft/vscode-docs/blob/main/api/ux-guidelines/activity-bar.md"></div>
				
				<div class="body-footer">6/3/2026</div>
				
            </main><aside class="docs-right-sidebar hidden-xs"><div class="docs-markdown-actions">
                    <div class="docs-markdown-dropdown" data-raw-url="/raw/api/ux-guidelines/activity-bar.md">
                ...
                <nav id="docs-subnavbar" aria-label="On Page"><h4><span class="sr-only">On this page there are 1 sections</span><span aria-hidden="true">On this page</span></h4>
                    <ul class="nav"><li><a href="#links-resources">Links Resources</a></li>
