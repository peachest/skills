...
> 源文档: [https://code.visualstudio.com/api/ux-guidelines/panel](https://code.visualstudio.com/api/ux-guidelines/panel)
		...
		<aside class="docs-left-sidebar"><nav id="docs-navbar" aria-label="Topics" class="docs-nav visible-md visible-lg"><h4>Extension API</h4>
			...
			<li class="panel active expanded">
			  ...
			  <ul id="ux-guidelines-articles" class="collapse in"><li>
			        ...
			        <li class="active">
			          <a href="/api/ux-guidelines/panel" aria-label="Current Page: Panel">Panel</a>
			        </li>
...
<li><a href="/api/extension-guides/tree-view#view-actions">View Actions extension guide</a></li>
                ...
                <nav id="docs-subnavbar" aria-label="On Page"><h4><span class="sr-only">On this page there are 2 sections</span><span aria-hidden="true">On this page</span></h4>
                    <ul class="nav"><li><a href="#panel-toolbar">Panel Toolbar</a></li>
